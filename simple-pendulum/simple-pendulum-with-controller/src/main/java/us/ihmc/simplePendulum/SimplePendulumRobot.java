 ...
 *
 */
public class SimplePendulumRobot extends Robot // by extending Robot, SimplePendulumRobot is inheriting some properties
												// and methods from the Robot class
{
	/*
	...
	public static final double FULCRUM_MOMENT_OF_INERTIA_ABOUT_Y = ROD_LENGTH * ROD_LENGTH * BALL_MASS; // I = mrˆ2
																										// pendulum's
																										// resistance to
																										// changes to
																										// its rotation
	...
	public SimplePendulumRobot() {
		/*
		 * Call parent class "Robot" constructor. The string "SimplePendulum" will be
