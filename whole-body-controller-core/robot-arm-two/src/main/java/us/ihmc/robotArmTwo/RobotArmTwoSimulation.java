...
/**
 * As in the {@code RobotArmOneSimulation} example, we will use the same 7-DoF
 * robot arm which is controlled using the IHMC whole-body controller core to
 * track the same sine-wave trajectories, see {@code RobotArmTwoController}.
 * <p>
...
public class RobotArmTwoSimulation {
	...
	public RobotArmTwoSimulation() {
		...
		RobotArmTwoController robotArmController = new RobotArmTwoController(robotArm, simulateDT, gravityMagnitude,
