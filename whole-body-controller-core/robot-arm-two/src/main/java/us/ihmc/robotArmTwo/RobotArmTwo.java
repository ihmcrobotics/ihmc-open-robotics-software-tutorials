...
/**
 * This is physically the same robot as {@link RobotArmOne}, it includes an
 * additional representation: "inverse dynamics robot model" that is used by the
 * IHMC whole-body controller core.
 */
public class RobotArmTwo {
	...
	/**
	 * A generator tool that can convert a simulated robot into what we often call
	 * an "inverse dynamics robot". This inverse dynamics represents the same robot
	 * but offers a different set of features. This type of robot is used by the
	 * controller core.
	 */
	...
	/**
	 * A reference frame which origin is at the center of mass of the robot. It is
	 * not used besides for creating the controller core in this example.
	 */
	private final ReferenceFrame centerOfMassFrame;
	/**
	 * The array containing in order from the base to the end-effector the joints
	 * our robot.
	 */
	 ...
	 * <p>
	 * The joint returned here is an "inverse dynamics joint" which is used by the
	 * controller core.
	 * </p>
	 * 
	 ...
	 * <p>
	 * This is useful when visualizing the result of an inverse kinematics
	 * controller which output desired joint configurations
	 * </p>
	 * 
