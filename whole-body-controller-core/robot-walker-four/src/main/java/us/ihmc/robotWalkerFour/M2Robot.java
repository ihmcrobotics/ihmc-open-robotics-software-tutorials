...
public class M2Robot extends Robot {
	...
	public M2Robot() {
		...
		Joint rightHipUni = new UniversalJoint("right_hip_yaw", "right_hip_roll", new Vector3D(0.0, -HIP_OFFSET_Y, 0.0),
				this, Axis3D.Z, Axis3D.X);
		...
		PinJoint rightKnee = new PinJoint("right_knee", new Vector3D(0.0, -HIP_TO_THIGH_OFF, -THIGH_LENGTH), this,
				Axis3D.Y);
		...
		Joint rightAnklePitch = new PinJoint("right_ankle_pitch", new Vector3D(0.0, 0.0, -ANKLE_JOINT_OFF), this,
				Axis3D.Y);
		...
		/*
		 * Here are defined the contact points that the simulation can use to make the
		 * ground interact with the robot. Without them the robot would fall through the
		 * ground.
		 */
		GroundContactPoint right_toe_in = new GroundContactPoint("gc_right_toe_in",
				new Vector3D(FOOT_FORWARD, FOOT_WIDTH / 2.0, -FOOT_HEIGHT), this);
		...
		GroundContactPoint right_heel_in = new GroundContactPoint("gc_right_heel_in",
				new Vector3D(-FOOT_BACK, FOOT_WIDTH / 2.0, -FOOT_HEIGHT), this);
		...
		Joint leftHipUni = new UniversalJoint("left_hip_yaw", "left_hip_roll", new Vector3D(0.0, HIP_OFFSET_Y, 0.0),
				this, Axis3D.Z, Axis3D.X);
		...
		PinJoint leftKnee = new PinJoint("left_knee", new Vector3D(0.0, HIP_TO_THIGH_OFF, -THIGH_LENGTH), this,
				Axis3D.Y);
		...
		Joint leftAnklePitch = new PinJoint("left_ankle_pitch", new Vector3D(0.0, 0.0, -ANKLE_JOINT_OFF), this,
				Axis3D.Y);
