...
public class RobotWalkerFive
{
   ...
   public RobotWalkerFive(ControllerInput controllerInput, ControllerOutput controllerOutput, M2RobotDefinition robotDefinition)
   {
