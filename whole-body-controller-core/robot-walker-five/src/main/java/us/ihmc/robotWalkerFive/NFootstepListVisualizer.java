...
public class  NFootstepListVisualizer implements SCS2YoGraphicHolder
{
   private static final int maxNumberOfFootstepsToVisualizePerSide = 5;
   ...
   public NFootstepListVisualizer(SideDependentList<? extends ContactablePlaneBody> contactableFeet,
